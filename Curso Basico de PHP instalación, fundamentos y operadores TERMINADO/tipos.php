...
$cuantas_papas_hay = $papas + 5; //lo suma pero da error
...
Este lenguaje no necesita que definas de forma explicita un tipo de dato, ya que por si mismo puede deducir que tipo de dato estás usando.
PHP es capaz de convertir un tipo de dato a otro de forma automatica según el contexto donde se use.
